...
model.to(device)
model=torch.load('/fs/class-projects/fall2024/cmsc848k/c848k063/FIRE/model_0.pth')
...
min_lr = max_lr / 10
warmup_steps = 715
max_steps = 100 #19073 # 19,073 steps is ~1 epoch, if data is 10B tokens and batch size 0.5M tokens
